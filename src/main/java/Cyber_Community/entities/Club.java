...
public class Club {
    ...
    public Club(String name,String description,String admin, String contact,Long id) {
        Blog test1 = new Blog("Blog test 1",
                ...
                "Resume","Author");
        Blog test2 = new Blog("Blog test 2","Content", "Resume","Author");
        this.name = name;
        this.description=description;
        this.admin=admin;
        this.contact= contact;
        this.blogs = new ArrayList<>(); //Create a new blog list with thw club
        this.blogs.add(test1);
        this.blogs.add(test2);
        this.id_Club=id;
    }
    ...
    public Blog getBlog(long idB) {
        return this.blogs.get((int)idB);
    }
    ...
    public void addBlog(long id, Blog b) {
        this.blogs.add((int)id, b);
    }
